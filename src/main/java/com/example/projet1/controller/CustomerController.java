...
import com.example.projet1.service.CustomerService;
...
public class CustomerController {
    ...
    public String viewHomePage(Model model) {
        ...
        model.addAttribute("listcustomert", listcustomer);
    ...
    public String saveCustomer(@ModelAttribute("customer") Customer  ctr) {
        service.save(ctr);
        return "redirect:/";
    }
